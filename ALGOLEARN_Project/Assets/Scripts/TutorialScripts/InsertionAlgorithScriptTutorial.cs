...
public class InsertionAlgorithScriptTutorial : MonoBehaviour
{
    ...
    void Update()
    {
        selectObjects(spawnList[0], spawnList[1]);
    ...
    void selectObjects(GameObject obj1, GameObject obj2)
    {
        moveObjects(obj1, obj2);
    }
    void moveObjects(GameObject obj1, GameObject obj2)
    {
        Vector3 BringObjectForward = obj1.transform.position;
        Vector3 BringObjectForward2 = obj2.transform.position;

        BringObjectForward.z = 8.5f;
        BringObjectForward2.z = 8.5f;

        obj1.transform.position = BringObjectForward;
        obj2.transform.position = BringObjectForward2;
    ...
    void returnToPosition(GameObject obj1, GameObject obj2)
    {

    }
    void SelectNext(GameObject obj1, GameObject obj2)
    {
